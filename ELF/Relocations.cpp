...
static bool needsGot(RelExpr expr) {
  return oneof<R_GOT, R_GOT_OFF, R_AARCH64_GOT_PAGE_PC, R_GOT_PC, R_GOTPLT>(
      expr);
}
...
static bool isRelExpr(RelExpr expr) {
  return oneof<R_PC, R_GOTREL, R_GOTPLTREL, R_PPC64_CALL, R_PPC64_RELAX_TOC,
               R_AARCH64_PAGE_PC, R_RELAX_GOT_PC, R_RISCV_PC_INDIRECT>(expr);
}
